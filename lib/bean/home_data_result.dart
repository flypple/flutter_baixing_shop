...
part 'home_data_result.g.dart';


@JsonSerializable()
class HomeDataResult extends Object {
  ...
  HomeDataResult(this.code,this.message,this.data,);

  factory HomeDataResult.fromJson(Map<String, dynamic> srcJson) => _$HomeDataResultFromJson(srcJson);

  Map<String, dynamic> toJson() => _$HomeDataResultToJson(this);
